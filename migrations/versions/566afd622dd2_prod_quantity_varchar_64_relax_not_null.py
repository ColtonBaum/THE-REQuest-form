...
def upgrade():
    ...
    op.execute("ALTER TABLE request_item ALTER COLUMN quantity DROP NOT NULL")
    op.execute("ALTER TABLE request_item ALTER COLUMN item_name DROP NOT NULL")
